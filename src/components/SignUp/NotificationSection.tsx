...
import NotifyCard from "../notifications/NotifyCard";
import ChartCard from "../notifications/ChartCard";
import Clockcard from "../notifications/Clockcard";
  ...
  return (
    <section>
      <div className="flex items-center justify-between w-full">
        ...
        <div className="h-full w-[405px] overflow-x-scroll overflow-hidden scrollbar-hide relative drop-shadow-xl">
          <div className="absolute inset-0 background z-20"></div>
          <div
            className="flex gap-[14px] w-[597px] pt-12 pl-[46px] pb-[84.5px] transition-transform duration-300 ease-in-out"
            style={{
